...
instance SeriesOptions SeriesBar where
  ...
  type SeriesOptions_coordinateSystem SeriesBar = Maybe Text
  type SeriesOptions_xAxisIndex SeriesBar = Maybe Int
  type SeriesOptions_yAxisIndex SeriesBar = Maybe Int
  type SeriesOptions_polarIndex SeriesBar = Maybe Int
  type SeriesOptions_symbol SeriesBar = Maybe Symbol
  type SeriesOptions_symbolSize SeriesBar = Maybe SymbolSize
  type SeriesOptions_symbolRotate SeriesBar = Maybe Int
  type SeriesOptions_symbolKeepAspect SeriesBar = Maybe Bool
  type SeriesOptions_symbolOffset SeriesBar = Maybe AbsOrPercent
  type SeriesOptions_showSymbol SeriesBar = Maybe Bool
  type SeriesOptions_showAllSymbol SeriesBar = Maybe Bool
  type SeriesOptions_hoverAnimation SeriesBar = Maybe Bool
  type SeriesOptions_legendHoverLink SeriesBar = Maybe Bool
  type SeriesOptions_stack SeriesBar = Maybe Text
  type SeriesOptions_cursor SeriesBar = Maybe Text
  type SeriesOptions_connectNulls SeriesBar = Maybe Bool
  type SeriesOptions_clipOverflow SeriesBar = Maybe Bool
  type SeriesOptions_step SeriesBar = Maybe Step
  type SeriesOptions_label SeriesBar = Maybe Label
  type SeriesOptions_itemStyle SeriesBar = Maybe ItemStyle
  type SeriesOptions_lineStyle SeriesBar = Maybe LineStyle
  type SeriesOptions_areaStyle SeriesBar = Maybe AreaStyle
  type SeriesOptions_smooth SeriesBar = Maybe (Either Bool ZeroToOne)
  type SeriesOptions_smoothMonotone SeriesBar = Maybe Text
  type SeriesOptions_sampling SeriesBar = Maybe Text
  type SeriesOptions_seriesLayoutBy SeriesBar = Maybe Text
  type SeriesOptions_datasetIndex SeriesBar = Maybe Int
  type SeriesOptions_markPoint SeriesBar = Maybe MarkPoint
  type SeriesOptions_markLine SeriesBar = Maybe MarkLine
  type SeriesOptions_markArea SeriesBar = Maybe MarkArea
  type SeriesOptions_z SeriesBar = Maybe Int
  type SeriesOptions_zlevel SeriesBar = Maybe Int
  type SeriesOptions_silent SeriesBar = Maybe Bool
  type SeriesOptions_animation SeriesBar = Maybe Bool
  type SeriesOptions_animationThreshold SeriesBar = Maybe Int
  type SeriesOptions_animationDuration SeriesBar = Maybe Aeson.Value
  type SeriesOptions_animationEasing SeriesBar = Maybe Text
  type SeriesOptions_animationDelay SeriesBar = Maybe Aeson.Value
  type SeriesOptions_animationDurationUpdate SeriesBar = Maybe Aeson.Value
  type SeriesOptions_animationEasingUpdate SeriesBar = Maybe Text
  type SeriesOptions_animationDelayUpdate SeriesBar = Maybe Aeson.Value
  type SeriesOptions_tooltip SeriesBar = Maybe ToolTip

instance SeriesOptions SeriesScatter where
  getSeriesTypeInt _ = "scatter"
  type SeriesOptions_coordinateSystem SeriesScatter = Maybe Text
  type SeriesOptions_xAxisIndex SeriesScatter = Maybe Int
  type SeriesOptions_yAxisIndex SeriesScatter = Maybe Int
  type SeriesOptions_polarIndex SeriesScatter = Maybe Int
  type SeriesOptions_symbol SeriesScatter = Maybe Symbol
  type SeriesOptions_symbolSize SeriesScatter = Maybe SymbolSize
  type SeriesOptions_symbolRotate SeriesScatter = Maybe Int
  type SeriesOptions_symbolKeepAspect SeriesScatter = Maybe Bool
  type SeriesOptions_symbolOffset SeriesScatter = Maybe AbsOrPercent
  type SeriesOptions_showSymbol SeriesScatter = Maybe Bool
  type SeriesOptions_showAllSymbol SeriesScatter = Maybe Bool
  type SeriesOptions_hoverAnimation SeriesScatter = Maybe Bool
  type SeriesOptions_legendHoverLink SeriesScatter = Maybe Bool
  type SeriesOptions_stack SeriesScatter = Maybe Text
  type SeriesOptions_cursor SeriesScatter = Maybe Text
  type SeriesOptions_connectNulls SeriesScatter = Maybe Bool
  type SeriesOptions_clipOverflow SeriesScatter = Maybe Bool
  type SeriesOptions_step SeriesScatter = Maybe Step
  type SeriesOptions_label SeriesScatter = Maybe Label
  type SeriesOptions_itemStyle SeriesScatter = Maybe ItemStyle
  type SeriesOptions_lineStyle SeriesScatter = Maybe LineStyle
  type SeriesOptions_areaStyle SeriesScatter = Maybe AreaStyle
  type SeriesOptions_smooth SeriesScatter = Maybe (Either Bool ZeroToOne)
  type SeriesOptions_smoothMonotone SeriesScatter = Maybe Text
  type SeriesOptions_sampling SeriesScatter = Maybe Text
  type SeriesOptions_seriesLayoutBy SeriesScatter = Maybe Text
  type SeriesOptions_datasetIndex SeriesScatter = Maybe Int
  type SeriesOptions_markPoint SeriesScatter = Maybe MarkPoint
  type SeriesOptions_markLine SeriesScatter = Maybe MarkLine
  type SeriesOptions_markArea SeriesScatter = Maybe MarkArea
  type SeriesOptions_z SeriesScatter = Maybe Int
  type SeriesOptions_zlevel SeriesScatter = Maybe Int
  type SeriesOptions_silent SeriesScatter = Maybe Bool
  type SeriesOptions_animation SeriesScatter = Maybe Bool
  type SeriesOptions_animationThreshold SeriesScatter = Maybe Int
  type SeriesOptions_animationDuration SeriesScatter = Maybe Aeson.Value
  type SeriesOptions_animationEasing SeriesScatter = Maybe Text
  type SeriesOptions_animationDelay SeriesScatter = Maybe Aeson.Value
  type SeriesOptions_animationDurationUpdate SeriesScatter = Maybe Aeson.Value
  type SeriesOptions_animationEasingUpdate SeriesScatter = Maybe Text
  type SeriesOptions_animationDelayUpdate SeriesScatter = Maybe Aeson.Value
  type SeriesOptions_tooltip SeriesScatter = Maybe ToolTip
